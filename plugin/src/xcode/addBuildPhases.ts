...
export function addBuildPhases(
  ...
  const buildPath = `"$(CONTENTS_FOLDER_PATH)/KeyboardExtensions"`;
  ...
  // Sources build phase
  xcodeProject.addBuildPhase(
    ["KeyboardExtensionViewController.swift"],
