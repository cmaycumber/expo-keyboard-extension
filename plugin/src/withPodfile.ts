...
import { getKeyboardExtensionName } from "./index";
...
export const withPodfile: ConfigPlugin<{
  ...
  use_expo_modules!(exclude: exclude)`
      ...
      const keyboardExtensionTarget = `target '${targetName}' do     
  ${useExpoModules}     
  ...
  use_react_native!(
    ...
    :flipper_configuration => flipper_config
      ...
      podfileContent = mergeContents({
        tag: "keyboard-extension-target",
        src: podfileContent,
        newSrc: keyboardExtensionTarget,
